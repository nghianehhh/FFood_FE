                              ...
                              orderItems.map((orderItem) => 
                                  <div className='col-order'>
                                      ...
                                      <div className="func-order">
                                          <button className="bg-danger bg-gradient fw-semibold">
                                              Hoàn thành
                                          </button>
  
                                          <button className="bg-primary bg-gradient fw-semibold" onClick={(e) => handleShow(orderItem, e)}>
                                              Thông tin
                                          </button>
                                      </div>
                                  </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageOrderDelivered);
